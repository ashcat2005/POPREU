...
dataFile = "/Users/blorangest/Desktop/spark-1.3.1-bin-hadoop2.6/round4_training_set.fits"
test_size = 0.2
num_trees = 6
max_depth = 10
k = 5
...
# removes unwanted cols and puts the relevant data in LabeledPoint objects
def parse (line): 
    #one of the cols has comma separated values enclosed by quotes
...
print "test"
rawdata = sc.parallelize(x[1].data)
print "test2"
print rawdata.count()
x.close()
